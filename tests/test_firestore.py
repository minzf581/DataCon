...
@pytest.mark.skip(reason="Firestore credentials not configured")
class TestFirestoreManager(TestCase):
    @pytest.mark.asyncio
...
if __name__ == '__main__':
    asyncio.run(TestFirestoreManager().test_firestore_operations()) 